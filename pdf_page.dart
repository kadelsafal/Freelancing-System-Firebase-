...
class _PDF_PageState extends State<PDF_Page> {
  ...
  Color MyColor = const Color.fromARGB(255, 222, 211, 8);
  ...
  var titleStyle2 = TextStyle(
      color: const Color.fromARGB(255, 131, 13, 161),
      fontSize: 14,
      fontWeight: FontWeight.w600);
  var detailStyle = const TextStyle(color: Colors.grey, fontSize: 12);
  var detailStyle2 =
      TextStyle(color: const Color.fromARGB(255, 252, 0, 0), fontSize: 12);
                    ...
                    children: [
                      ...
                      (Global.name != null)
                          ? Text(
                              ...
                              style: TextStyle(
                                fontSize: 17,
                                color: const Color.fromARGB(255, 36, 225, 7),
                                fontWeight: FontWeight.w600,
                              ),
                            )
                          : Container(),
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 1, 113, 8),
